    ...
    var DatePickerPanel = function (_Jinkela3) {
      ...
      _createClass(DatePickerPanel, [{
        ...
        set: function set(value) {
          ...
          this.commit(function () {
            _this16.year += Math.floor(value / 12);
            value = (value % 12 + 12) % 12;
            _this16.$month = _this16.dpy.month = _this16.dpm.month = _this16.dpd.month = value;
            _this16.monthText = _this16.$month + 1;
          });
        }
      }, {
        key: 'date',
        ...
        set: function set(date) {
          ...
          try {
            ...
            this.commit(function () {
              _this17.year = date.getFullYear();
              _this17.month = date.getMonth();
              _this17.date = date.getDate();
            });
          } catch (error) {
            this.resetYear();
          }
      ...
      _createClass(DatePicker, [{
        ...
        value: function init() {
          ...
          addEventListener('click', function (event) {
            return _this21.checkClose(event);
          });
          this.element.addEventListener('click', function (event) {
            return event.relatedDatePicker = _this21;
          });
          this.element.addEventListener('focus', function () {
            return _this21.element.className = 'active';
          }, true);
          Object.defineProperty(this.element, 'value', { get: function get() {
              return _this21.value;
            }, set: function set(value) {
              return _this21.value = value;
            } });
        }
      }, {
        key: 'onChange',
