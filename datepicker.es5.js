  ...
  (function () {
    ...
    var DatePickerField = (function (_Jinkela4) {
      ...
      function DatePickerField() {
        ...
        _get(Object.getPrototypeOf(DatePickerField.prototype), 'constructor', this).apply(this, arguments);
      }
    ...
    var DatePicker = (function (_Jinkela5) {
      ...
      _createClass(DatePicker, [{
        ...
        value: function init() {
          ...
          this.field = new DatePickerField({ onClick: function onClick() {
              return _this4.element.className = 'active';
            } }).renderTo(this);
          ...
          addEventListener('click', function (event) {
            return _this4.checkClose(event);
          });
          this.element.addEventListener('click', function (event) {
          ...
          Object.defineProperty(this.element, 'value', { get: function get() {
              ...
              return _this4.value = value;
            } });
          this['@@didMountHandlers'].push(function () {
            if (!('$value' in _this4)) return;
        ...
        key: 'update',
        value: function update() {
          this.field.text = this.panel.text || this.defaultText || '请选择';
        }
      }, {
        key: 'change',
